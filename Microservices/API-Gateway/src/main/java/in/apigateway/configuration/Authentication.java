package in.apigateway.configuration;

import in.apigateway.dto.UserDto;
...
@Component
public class Authentication extends AbstractGatewayFilterFactory<Authentication.Config> {

    private final WebClient.Builder webClientBuilder;

    public Authentication(WebClient.Builder webClientBuilder) {
        super(Config.class);
